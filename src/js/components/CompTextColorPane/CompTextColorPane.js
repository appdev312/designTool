...
addStyle(Button, 'tap');
export default class CompTextColorPane extends Component {
  ...
  constructor(props, context) {
    ...
    this.state = {
      selected: props.selectedFontColor ? props.selectedFontColor : props.colorList[0],
      open: false
    };
  }
  ...
  render () {
    ...
    if (typeof subtitle === 'undefined') {
      subtitle = 'Tap To Choose Your Font Color:';
    }

    return (
      <div className="mb-textcolor-option-pane">
